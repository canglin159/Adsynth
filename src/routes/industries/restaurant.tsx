...
function RestaurantIndustryPage() {
  ...
  const schema = {
    ...
    "@type": "Service",
    "name": "Restaurant AI Ad Creative Service",
    "description": "Appetizing ad creatives for restaurants, cafes, and food businesses.",
    "provider": {
      "@type": "Organization",
      "name": "AdSynth"
    }
    ...
    <div className="min-h-screen bg-white dark:bg-gray-950 text-gray-900 dark:text-gray-100 font-sans">
      ...
      <header className="py-16 md:py-24 px-4 relative overflow-hidden">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full pointer-events-none">
          ...
          <div className="bottom-0 left-1/4 w-96 h-96 bg-red-500/10 blur-[100px] rounded-full" />
        </div>
        
        <div className="max-w-7xl mx-auto relative z-10">
          <Breadcrumbs items={[{ label: "Industries", to: "/industries" }, { label: "Restaurant" }]} />
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-left">
              ...
              <h1 className="text-4xl md:text-6xl font-bold tracking-tight mb-6 leading-tight">
                Drive More Covers with <span className="text-orange-500">Crave-Worthy Ads</span>
              </h1>
              <p className="text-xl text-gray-600 dark:text-gray-400 mb-10 leading-relaxed max-w-xl">
                From Instagram-ready food photography to high-conversion delivery promos. AdSynth helps your restaurant stand out in the local food scene.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white dark:bg-gray-900 p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800">
              ...
              <h3 className="text-xl font-bold mb-3">Happy Hour Promos</h3>
              <p className="text-gray-600 dark:text-gray-400">Timely ads that drive foot traffic during your slowest hours.</p>
            </div>
            <div className="bg-white dark:bg-gray-900 p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800">
              ...
              <h3 className="text-xl font-bold mb-3">Delivery Focused</h3>
              <p className="text-gray-600 dark:text-gray-400">Creatives optimized to drive orders through your website or third-party apps.</p>
            </div>
            <div className="bg-white dark:bg-gray-900 p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800">
              ...
              <h3 className="text-xl font-bold mb-3">New Menu Alerts</h3>
              <p className="text-gray-600 dark:text-gray-400">Exciting visuals for seasonal menu launches and special events.</p>
            </div>
          </div>
        </div>
      </section>

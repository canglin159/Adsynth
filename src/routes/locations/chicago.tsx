...
export const Route = createFileRoute("/locations/chicago")({
  head: () => ({
    meta: [
      { title: "AdSynth | AI Ad Creatives for Local Businesses in Chicago, IL" },
      { name: "description", content: "Dominate the Chicago market with AI-powered ad creatives. Specialized Facebook, Instagram, and Google ads for Chicago HVAC, dental, and roofing businesses." },
      { name: "og:title", content: "AI Ad Creatives for Chicago Local Businesses | AdSynth" },
      { name: "og:description", content: "Get high-converting AI-generated ads for your Chicago business. Fast delivery, local expertise." },
      { name: "canonical", content: "https://adsynth.ctonew.app/locations/chicago" }
    ]
  }),
  component: ChicagoLocationPage,
});
...
function ChicagoLocationPage() {
  const schema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Chicago Local Ad Creative Service",
    "provider": {
      "@type": "Organization",
      "name": "AdSynth"
    },
      ...
      <main>
        <header className="py-24 px-4 bg-gray-50 dark:bg-gray-900/50">
          <div className="max-w-4xl mx-auto text-center">
            <Breadcrumbs items={[{ label: "Locations" }, { label: "Chicago, IL" }]} />
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-brand-50 dark:bg-brand-950 text-brand-700 dark:text-brand-300 text-xs font-bold uppercase tracking-wider mb-8">
              ...
              Local Service: Chicago, IL
            </div>
            <h1 className="text-4xl md:text-6xl font-bold tracking-tight mb-6 leading-tight">
              Scale Your Chicago Business with <span className="text-brand-500">AI-Powered Ads</span>
            </h1>
            <p className="text-xl text-gray-600 dark:text-gray-400 mb-10 max-w-2xl mx-auto">
              From the Loop to the suburbs, reach Chicago customers exactly when they're looking for your services. AdSynth delivers conversion-optimized ads tailored for the Windy City.
            </p>
        ...
        <section className="py-24 px-4 max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl font-bold mb-6">Why Chicago Service Businesses Choose AdSynth</h2>
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-lg mb-1">Windy City Seasonal Edge</h3>
                    <p className="text-gray-600 dark:text-gray-400">Instantly swap from heating to cooling ads as Chicago's unpredictable weather shifts.</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400">Creatives that emphasize reliability and local expertise for Chicago neighborhoods.</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-lg mb-1">Data-Driven Growth</h3>
                    <p className="text-gray-600 dark:text-gray-400">Stop guessing. Use AI that knows what Chicago homeowners click on.</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="bg-gradient-to-br from-brand-500/10 to-purple-500/10 p-1 rounded-3xl">
              <div className="bg-white dark:bg-gray-950 p-8 rounded-[1.4rem] shadow-sm">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed italic mb-6">
                  "In a city as competitive as Chicago, standing out is everything. Whether you're a plumber in Lincoln Park or a roofer in Naperville, your advertising needs to be sharp, local, and fast. AdSynth gives Chicago businesses the same high-end creatives used by national brands at a fraction of the cost."
                </p>
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-brand-500 rounded-full"></div>
                  <div>
                    <p className="font-bold text-sm">AdSynth Local Insights</p>
                    <p className="text-xs text-gray-500">Market Analysis: Chicago, IL</p>
                  </div>
                </div>
              </div>
            </div>

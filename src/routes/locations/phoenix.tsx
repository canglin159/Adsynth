...
export const Route = createFileRoute("/locations/phoenix")({
  head: () => ({
    meta: [
      { title: "AdSynth | AI Ad Creatives for Local Businesses in Phoenix, AZ" },
      { name: "description", content: "Beat the heat with AI-powered ad creatives for your Phoenix business. Specialized Facebook, Instagram, and Google ads for Phoenix HVAC, landscaping, and dental practices." },
      { name: "og:title", content: "AI Ad Creatives for Phoenix Local Businesses | AdSynth" },
      { name: "og:description", content: "Get high-converting AI-generated ads for your Phoenix business. Fast delivery, local expertise." },
      { name: "canonical", content: "https://adsynth.ctonew.app/locations/phoenix" }
    ]
  }),
  component: PhoenixLocationPage,
});
...
function PhoenixLocationPage() {
  const schema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Phoenix Local Ad Creative Service",
    "provider": {
      "@type": "Organization",
      "name": "AdSynth"
    },
      ...
      <main>
        <header className="py-24 px-4 bg-gray-50 dark:bg-gray-900/50">
          <div className="max-w-4xl mx-auto text-center">
            <Breadcrumbs items={[{ label: "Locations" }, { label: "Phoenix, AZ" }]} />
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-brand-50 dark:bg-brand-950 text-brand-700 dark:text-brand-300 text-xs font-bold uppercase tracking-wider mb-8">
              ...
              Local Service: Phoenix, AZ
            </div>
            <h1 className="text-4xl md:text-6xl font-bold tracking-tight mb-6 leading-tight">
              Scale Your Phoenix Business with <span className="text-brand-500">AI-Powered Ads</span>
            </h1>
            <p className="text-xl text-gray-600 dark:text-gray-400 mb-10 max-w-2xl mx-auto">
              From Scottsdale to Tempe, reach Phoenix homeowners exactly when they're looking for your services. AdSynth delivers conversion-optimized ads tailored for the Valley of the Sun.
            </p>
        ...
        <section className="py-24 px-4 max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl font-bold mb-6">Why Phoenix Service Businesses Choose AdSynth</h2>
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-lg mb-1">Beat the Phoenix Heat</h3>
                    <p className="text-gray-600 dark:text-gray-400">High-converting ads for emergency HVAC repair and desert-friendly landscaping.</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-lg mb-1">Local Market Expertise</h3>
                    <p className="text-gray-600 dark:text-gray-400">Creatives that resonate with Phoenix homeowners and their unique desert needs.</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-lg mb-1">24-Hour Delivery</h3>
                    <p className="text-gray-600 dark:text-gray-400">Launch your summer campaigns in record time. Don't let your competitors take the lead.</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="bg-gradient-to-br from-brand-500/10 to-purple-500/10 p-1 rounded-3xl">
              <div className="bg-white dark:bg-gray-950 p-8 rounded-[1.4rem] shadow-sm">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed italic mb-6">
                  "In Phoenix, when the AC goes out, it's an emergency. You need ads that stop the scroll and win the click instantly. AdSynth provides Phoenix businesses with high-end, conversion-optimized creatives that deliver real results during our most critical seasons."
                </p>
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-brand-500 rounded-full"></div>
                  <div>
                    <p className="font-bold text-sm">AdSynth Local Insights</p>
                    <p className="text-xs text-gray-500">Market Analysis: Phoenix, AZ</p>
                  </div>
                </div>
              </div>
            </div>
